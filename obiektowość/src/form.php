...
<body>
    <div class="flex justify-around items-center p-8">
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data" action="formPOST.php"
            method="post">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight focus:outline-none focus:shadow-outline"
                    type="text" name="pesel" pattern="\d{11}" title="11 cyfr" />
            </div>
            <div class="mb-4">
                <label class="block text-grey-darker text-sm font-bold mb-2">
                    e-mail
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight focus:outline-none focus:shadow-outline"
                    type="email" name="email" placeholder="mail@mail.com" />
            </div>
            <div class="mb-4">
                <label class="block text-grey-darker text-sm font-bold mb-2">
                    Zgody
            ...
            <div class="mb-4">
                <td colspan="2"><input class="bg-blue hover:bg-blue-dark text-white font-bold py-2 px-4 w-full rounded focus:outline-none focus:shadow-outline"
                        type="submit" name="zatwierdz" value="zatwierdź" />
            </div>
