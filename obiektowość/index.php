            ...
            <table>
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker leading-tight focus:outline-none focus:shadow-outline"
                        type="number" name="kwota" value="1000" step="1" max="100000" />
                </div>
                <div class="mb-4">
                    <label class="block text-grey-darker text-sm font-bold mb-2">
                        Okres pożyczki (lata)
                ...
                <div class="mb-4">
                    <input class="bg-blue hover:bg-blue-dark text-white font-bold py-2 px-4 w-full rounded focus:outline-none focus:shadow-outline"
